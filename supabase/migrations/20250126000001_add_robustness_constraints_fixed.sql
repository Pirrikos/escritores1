-- ==========================================
-- ROBUSTNESS CONSTRAINTS MIGRATION (FIXED)
...
-- Add basic indexes for performance (without problematic predicates)
...
VALUES ('20250126000001_add_robustness_constraints_fixed', now())
