...
const Toast: React.FC<ToastProps> = ({ toast, onRemove }) => {
  ...
  const getIconStyles = (type: ToastVariant) => {
    switch (type) {
      case 'success':
  ...
  return (
    <div
      className={cn(
        'pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg shadow-lg transition-all duration-300 ease-in-out',
    ...
    >
      <div className="p-4">
        <div className="flex items-start">
          <div className={cn('flex-shrink-0', getIconStyles(toast.type))}>
            {getIcon(toast.type)}
          </div>
